...
exports.tanggal = (numer) => {
    const myMonths = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "Kctober", "November", "December"];
    ...
    const time = moment.tz('Africa/Zimbabwe').format('DD/MM HH:mm:ss');
    const d = new Date();
    const locale = 'id';
    const gmt = new Date(0).getTime() - new Date('1 January 1924').getTime();
